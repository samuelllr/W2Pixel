...
function weditoractivepixel( idxx , idyy  ){
    wvir++;
    var ps , getrectt , idxy , attps ;
    idxy = idxx +","+ idyy ;
    //visualizar
         wPoint( idxx , idyy );
    //=======
    ps = document.createElement( "p" );
    attps = document.createAttribute( "style" );
    attps.value = "display:inline";
    ps.setAttributeNode( attps );
    if( wvir <= 1 ){
        ps.innerHTML = idxx+","+idyy ;
    }if( wvir > 1 ){
        ps.innerHTML = ","+idxx+","+idyy ;
    }
